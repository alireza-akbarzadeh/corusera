...
export function Navbar({user}: NavbarProps) {
    ...
    const handleSignOut = async () => {
        await authClient.signOut({
            ...
            toast.success(t('success_logout', {values: {name: 'Alireza'}}))
        ...
        <header className="sticky top-0 z-50 w-full bg-gradient-to-r from-gray-950 via-slate-900 to-black">
            <div className="px-6 flex h-16 items-center">
                ...
                <Sheet>
                    ...
                    <SheetContent
                        side="left"
                        className="pr-0 bg-slate-900 border-white/10"
                    >
                        <MobileNav user={user}/>
                    </SheetContent>
                </Sheet>
                ...
                <Link href="/" className="mr-6 flex items-center space-x-2 group">
                    <div
                        className="w-8 h-8 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform">
            ...
            LearnHub
                ...
                <NavigationMenu className="hidden lg:flex">
                    <NavigationMenuList>
                        <NavigationMenuItem>
                            <NavigationMenuTrigger
                                className="bg-transparent text-white hover:bg-white/10 hover:text-white focus:bg-white/10 focus:text-white data-[active]:bg-white/10 data-[state=open]:bg-white/10">
                                Courses
                            </NavigationMenuTrigger>
                ...
                <div className="flex items-center space-x-2">
                    ...
                    {user && (
                        ...
                        >
                            ...
                            <Badge
                                className="absolute -right-1 -top-1 h-5 w-5 rounded-full p-0 text-xs bg-gradient-to-r from-purple-500 to-blue-500 text-white border-0">
                                3
                            </Badge>
